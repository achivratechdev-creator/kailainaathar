...
import CertificateCard from "@/components/ui/cards/home/CertificateCard";
import AppointmentRequestForm from "@/components/forms/appointment/AppointmentRequestForm";
                                                          ...
                                                          data-name="Component 2"><svg className="block size-full"
                                                              ...
                                                              <g id="Component 2">
                                                                  <path clipRule="evenodd"
                                                                      ...
                                                                      fill-rule="evenodd" id="Vector"></path>
                                                              </g>
                                                          </svg></div>
                                                      <div className="relative shrink-0 size-[20px]"
                                                          data-name="Component 2"><svg className="block size-full"
        ...
        {/* Patient stories yet to add */}
          ...
          <section id="license" className="bg-[rgba(240,253,244,0.5)] py-16 px-4 sm:px-8 md:px-20">
              <div className="max-w-[1280px] mx-auto flex flex-col gap-12 items-center">
                  ...
                  <CertificateCard
                    imageSrc="/assets/img/f4a553e7eeae725ac99d8209f35ba955be60d55b.png"
