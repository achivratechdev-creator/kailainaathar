        ...
        <div className="max-w-[1320px] mx-auto px-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              <Link href="/product-detail" className="flex items-center gap-2 text-gray-600 hover:text-[#2e7d32] font-medium text-sm transition-colors group">
          ...
          {cartProducts.length === 0 ? (
            <div className="text-center py-20 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <Link href="/product-detail" className="px-6 py-3 bg-[#2e7d32] text-white rounded-lg font-medium hover:bg-[#256629] transition-all">
                Start Shopping
              </Link>
            </div>
          ) : (
